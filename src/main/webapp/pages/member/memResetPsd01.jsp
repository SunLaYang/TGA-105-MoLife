...
<body>
	...
	<div class="login-box">
		...
		<div class="col
	text-center">
			<p class="login-box-msg">會員輸入信箱來重設密碼</p>
		</div>
		...
		<form METHOD="post" ACTION="/memberController" name="confirmEmail">
	...
	<div>
		<div class="col text-center">
			<input type="hidden" name="action" value="confirmEmail"> <input
				class="btn btn-primary login_button" type="submit" value="提交信箱"
