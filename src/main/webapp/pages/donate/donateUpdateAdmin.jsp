      ...
      <section class="content">
        ...
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">提案募款紀錄 - 修改進度</h3>
          </div>
        </div>
                  ...
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      <tr>
                       ...
                       <!-- align-right -->
  								<img src="AnimalPhotoServlet?planId=${result.planId}">
                            <!-- <a onclick="location.href='AnimalPhotoServlet?planId=${result.planId}';" class="btn btn-info"><i class="fas fa-eye" ></i></a> -->
                          </div>
                          </td>
                ...
                <div class="card card-primary">
                  ...
                  <div class="card-body">
                    <table class="table table-striped">
                        ...
                        <tr>
                          <td>募款所需天數</td>
                          <td>${result.donateDays}</td>
                        </tr>

                        <tr>
                          <td>募款目標金額</td>
                          <td>$${result.donateGoal}</td>
                        </tr>

                        <tr>
                          <td>Youtube影片連結</td>
                          <td>${result.animalVideoLink}</td>
                        </tr>
                </table>
                  </div>
                  <!-- /.card-body -->
...
<form method="post" ACTION="<%=request.getContextPath()%>/pages/donate/AdminUpdateServlet">
 <div>
	...
	<label>進度變更&emsp;</label>
		<select id="inputStatus" name="planStatusId">
	...
	<div style="width:100%">
		<label>系統備註&emsp;</label>
			<input type="text" name="planStatusComment"></input>
	</div>

	<div>
    	<label for="donate_end_date">募款結束日期&emsp;</label>
       		<input type="date" name="donateEndDate">
	</div>
	<br>
	...
	<div class="row">
    	<div class="col-12">
        	...
        	<input type="hidden" value="${result.planId}" name="id">
            <input type="hidden" name="adminAction" value="updateAdmin">
         	<input type="submit" class="btn btn-success" id="submit" value="確認修改計畫進度"></input>
         	<script>
...
<!-- /.content -->
    ...
    <footer class="main-footer">
      <strong>MoLife <i class="fa-solid fa-paw"></i> &copy; 2022
